...
const projet = await ProjectDuaLipa(props.id);
...
<template>
    <div class="project__page">
        ...
        <div class="px-4 py-5 sm:px-14 sm:py-14">
            ...
            <div class="max-w-[1110px] mt-14 sm:mt-24">{{ projet.description1 }}</div>
            <div class="flex justify-end">
                <div class="text-end max-w-[510px] mt-14 sm:mt-40">{{ projet.description2 }}</div>
            </div>
            <div class="relative mt-14 sm:mt-24 h-[200px] sm:h-[350px] lg:h-[450px] xl:h-[690px] lg:w-[80%]">
                <img id="img1" class="absolute top-0 left-0 animate--anim opacity-100 z-30 max-w-[52%]" :src="urlImg1_1" alt="Image du projet"
                    @mouseenter="handleMouseEnter(1)" @mouseleave="handleMouseLeave">
                <img id="img2" class="absolute top-0 left-0 animate--anim opacity-100 z-20 max-w-[79%]" :src="urlImg1_2" alt="Image du projet"
                    @mouseenter="handleMouseEnter(2)" @mouseleave="handleMouseLeave">
                <img id="img3" class="absolute top-0 left-0 animate--anim opacity-100 z-10" :src="urlImg1_3" alt="Image du projet"
            ...
            <div class="flex mt-16 sm:mt-36 mb-16 w-[80%] lg:w-[70%]">
                <img id="img--scd1" class="animate--anim opacity-100 z-30" :src="urlImg2_1" alt="Image du projet"
                    @mouseenter="handleMouseEnterScd(1)" @mouseleave="handleMouseLeave">
                <img id="img--scd2" class="animate--anim opacity-100 z-20 -ml-[91%]" :src="urlImg2_2" alt="Image du projet"
                    @mouseenter="handleMouseEnterScd(2)" @mouseleave="handleMouseLeave">
                <img id="img--scd3" class="animate--anim opacity-100 z-10 -ml-[91%]" :src="urlImg2_3" alt="Image du projet"
