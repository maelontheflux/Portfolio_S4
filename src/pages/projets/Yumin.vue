...
import { pb, ProjectYumin } from '@/backend';
...
const projet = await ProjectYumin(props.id);
...
<template>
    <div class="project__page">
        ...
        <div class="px-4 py-5 sm:px-14 sm:py-14">
            ...
            <div class="flex mt-14 sm:mt-24 w-[80%] lg:w-[45%]">
                <img id="img1" class="animate--anim opacity-100 z-10" :src="urlImg1_1" alt="Image du projet"
            ...
            <div class="flex mt-16 sm:mt-36 mb-16 w-[70%] lg:w-[45%]">
                ...
                <img id="img--scd2" class="animate--anim opacity-100 z-20 -ml-[80%]" :src="urlImg2_2" alt="Image du projet"
                    @mouseenter="handleMouseEnterScd(2)" @mouseleave="handleMouseLeave">
                <img id="img--scd3" class="animate--anim opacity-100 z-10 -ml-[80%]" :src="urlImg2_3" alt="Image du projet"
